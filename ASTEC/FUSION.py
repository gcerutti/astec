...
def fusion(images_input, image_output,temporary_path,ori, mirrors=False, targetResolution=1.0):
...
def fusion_process(time_angles_files,output_file,temporary_path,
    ...
    fusion(cropped_files,output_file, temporary_path , ori, mirrors, targetResolution=target_resolution)
